...
h4. 1.7.3-nimbleapps1

* Fixed the height and width setting bug ("nimbleapps":http://github.com/nimbleapps)
* Merged changes from #99
* Merged changes from #36

h4. 1.7.3

* Fixed the #4 bug ("tuupola":http://github.com/tuupola)
* Updated the Autogrow plugin URL ("tuupola":http://github.com/tuupola)
* Added a jQuery based datepicker ("hitsvilleusa":https://github.com/hitsvilleusa)
* Added an old autocomplete demo ("tuupola":http://github.com/tuupola)
